...
description: |
  InchHeart Wisdom：问题型核心教授技能。用于用户要求教授视角、学院派分析、论文支援、研究设计、
  概念辨析、证据审查、学科框架、代码/AI/工程严谨分析、创作批评、法律/经济/政治/社会/心理/医学/生物/运动/物理问题拆解时。
  本技能只保留并暴露 15 个问题型核心教授；旧 16 学科教授和细分 references 已删除，不作为路由入口。
---
